...
Z Wyresu można zauważyć, że dla wartości k=1, wartość optymalna Tk=1 ze względu, że nie występują duże wachania wartości, a układ szybko jest w stanie ustalonym.
...
\begin{figure}[!h]
	...
	\caption{Zmiana C przy stałym k=0.5 i Tk=1}
    \label{fig:Rysunek}
\end{figure}
