...
\item Inercyjny II rzędu
\newline \includegraphics[scale=0.8]{CW1-inercyjny2-impuls.eps}
\newline \includegraphics[scale=0.8]{CW1-inercyjny2-skok.eps}
\item Całkujący rzeczywisty
\newline \includegraphics[scale=0.8]{CW1-calkujacy-impuls.eps}
\newline \includegraphics[scale=0.8]{CW1-calkujacy-skok.eps}
\item Różniczkujący rzeczywisty
\newline \includegraphics[scale=0.8]{CW1-rozniczkujacy-impuls.eps}
\newline \includegraphics[scale=0.8]{CW1-rozniczkujacy-skok.eps}
\item Proporcjonalny
...
%\begin{itemize}
%\item Inercyjny I rzędu
%\newline \includegraphics[scale=0.8]{CW1-inercyjny1-mimpuls.eps}
%\newline \includegraphics[scale=0.8]{CW1-inercyjny1-mskok.eps}
%\item Inercyjny II rzędu
%\newline \includegraphics[scale=0.8]{CW1-inercyjny2-mimpuls.eps}
%\newline \includegraphics[scale=0.8]{CW1-inercyjny2-mskok.eps}
%\item Całkujący rzeczywisty
%\newline \includegraphics[scale=0.8]{CW1-calkujacy-mimpuls.eps}
%\newline \includegraphics[scale=0.8]{CW1-calkujacy-mskok.eps}
%\item Różniczkujący rzeczywisty
%\newline \includegraphics[scale=0.8]{CW1-rozniczkujacy-mimpuls.eps}
%\newline \includegraphics[scale=0.8]{CW1-rozniczkujacy-mskok.eps}
%\item Proporcjonalny
%\newline \includegraphics[scale=0.8]{CW1-proporcjonalny-mimpuls.eps}
%\newline \includegraphics[scale=0.8]{CW1-proporcjonalny-mskok.eps}
%\end{itemize}
